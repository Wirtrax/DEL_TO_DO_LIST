import styles from './TaskHolderStyle.module.css';
...
const TaskHolder: React.FC<TaskHolderProps> = ({ label, idTasks, taskName, onDelete, onUpdate }) => {
  const handleDelete = () => {
    onDelete(idTasks);
  };
  ...
  return (
    <div className={styles.task}>
      ...
      <div className={styles.task__buttonGroup}>
        <button onClick={handleDelete} className={styles.task__button}>
          <svg
            version="1.0"
            ...
            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
              <path
                d="M1871 5109 c-128 -25 -257 -125 -311 -241 -37 -79 -50 -146 -50 -259
...
90 c0 110 20 159 78 189 36 19 60 20 670 21 615 0 634 -1 672 -20z"
              />
              <path
                d="M625 3578 c3 -24 62 -727 130 -1563 69 -836 130 -1558 136 -1605 24
...
25 86 25 137 0z"
        ...
        <button onClick={handleUpdate} className={styles.task__button}>
          <svg
            version="1.0"
            xmlns="http://www.w3.org/2000/svg"
            width="30px"
